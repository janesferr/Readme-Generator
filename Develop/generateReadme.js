...
inquirer
    ...
    .then((response) => {
        ...
        //          renderLicenseBadge = [![License](https://img.shields.io/badge/License-BSD%203--Clause-blue.svg)](https://opensource.org/licenses/BSD-3-Clause)
        ...
        const newImage = `![alt text](${response.usage})`;
